...
ACLOCAL = ${SHELL} /opt/git/mousetrap/missing --run aclocal-1.12
ALL_LINGUAS = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /opt/git/mousetrap/missing --run autoconf
AUTOHEADER = ${SHELL} /opt/git/mousetrap/missing --run autoheader
AUTOMAKE = ${SHELL} /opt/git/mousetrap/missing --run automake-1.12
AWK = gawk
CATALOGS = 
CATOBJEXT = .gmo
CC = gcc
...
MAINT = 
MAKEINFO = ${SHELL} /opt/git/mousetrap/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
...
abs_builddir = /opt/git/mousetrap
abs_srcdir = /opt/git/mousetrap
abs_top_builddir = /opt/git/mousetrap
abs_top_srcdir = /opt/git/mousetrap
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /opt/git/mousetrap/install-sh
